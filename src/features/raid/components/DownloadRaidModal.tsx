...
interface DownloadRaidModalProps {
  isOpen: boolean;
  onClose: () => void;
  seasons: any[];
  ...
  setIncludeScore: (val: boolean) => void;
  onDownload: () => void;
  isGeneratingImage: boolean;
}

const DownloadRaidModal: React.FC<DownloadRaidModalProps> = ({
  isOpen,
  onClose,
  seasons,
  downloadConfig,
...
export default DownloadRaidModal;
